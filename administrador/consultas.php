...
//print_r($FRM); 
 ...
 if($FRM['identificador']=="personales")
 {
	...
	$txtConsulta = "INSERT INTO rescatista(CI, NOMBRE, APELLIDO,FECHA_NAC, LUGAR_NACIMIENTO, EMAIL, FACEBOOK, TELEFONO, TELEFONO_EMERGENCIA, DIRECCION) VALUES(".$FRM['ci'].", '".$FRM['nombre']."', '".$FRM['apellido']."', '".$FRM['lugarnac']."', '".$fechaNac."', '".$FRM['email']."', '".$FRM['fb']."', ".$FRM['tlf'].", ".$FRM['tlfemerg'].", '".$FRM['direccion']."')";
 }
